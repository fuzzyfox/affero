		...
		<body>
			...
			<div class="section">
				<div class="article">
					...
					<p class="error">an unknown error occured meaning your account was not deleted<br>please try again... if the problem persists contact us and we will remove your account for you</p>
					<?php endif; ?>
					<form method="post" action="<?php echo$this->site_url('backend/user/delete'); ?>">
						...
						<div class="controls">
							<button type="submit">delete</button> <button onclick="history.go(-1);">cancel</button>
						</div>
					</form>
				</div>
			</div>
